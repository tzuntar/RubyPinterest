...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference("Pin.count") do
      post pins_url, params: { pin: { description: @pin.description, title: @pin.title, url: @pin.url } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { description: @pin.description, title: @pin.title, url: @pin.url } }
